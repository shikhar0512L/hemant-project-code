                ...
                <div className="flex flex-wrap -m-4">
                    <div className="p-4 md:w-1/2 w-full">
                        <div className="h-full bg-gray-100 p-8 rounded">
                            ...
                            <p className="leading-relaxed mb-6">This man shows its school projects which are very helpful for school students. And best part is he is a developer also. And he post nice blogs also.</p>
                            <span className="inline-flex items-center">
                                <span className="flex-grow flex flex-col pl-4">
                                    <span className="title-font font-medium text-gray-900">Shikhar singh</span>
                                    <span className="text-gray-500 text-sm">Master Developer</span>
                                </span>
                            </span>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/2 w-full">
                        <div className="h-full bg-gray-100 p-8 rounded">
                            ...
                            <span className="inline-flex items-center">
                                <span className="flex-grow flex flex-col pl-4">
                                    <span className="title-font font-medium text-gray-900">SiddhuBro</span>
