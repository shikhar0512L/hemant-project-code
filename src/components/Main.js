        ...
        <>
            <div className="flex bg-white h-96 container mx-auto">
                <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
                    <div>
                        <h2 className="text-3xl hover:animate-bounce font-semibold text-gray-800 md:text-4xl">Welcome to <span className="text-indigo-600">Hemant's Project</span></h2>

                        <p className="mt-2 text-sm text-gray-500 md:text-base ">
                            HI guys i am Hemant's project
                            I create fun , coding , blog videos in my channel.
                        </p>

                        <div className="flex justify-center lg:justify-start mt-6">
                            <a href="https://discord.gg/jQ5GzSpgEq" className="px-3 py-2 lg:px-4 lg:py-3 bg-gray-900 text-gray-200 text-xs font-semibold rounded hover:bg-gray-800 hover:animate-bounce hover:text-white" target="_blank">Discord</a>
                            <a href="https://www.youtube.com/channel/UCzeALSxw6-_NrjuGcIIY44g?sub_confirmation=1" className="px-3 py-2 mx-4 lg:px-4 lg:py-3 bg-gray-300 text-gray-900 text-xs font-semibold rounded hover:bg-gray-400 hover:animate-bounce hover:text-gray-900" target="_blank">Subscribe</a>
            ...
            <h2 className="text-3xl font-medium title-font text-gray-900 my-10 text-center hover:animate-bounce">Recommended Courses - Code With shikhar</h2>
